...
\maketitle
\begin{abstract}
这里填写中文摘要正文。摘要环境会映射到 schema 中的中文摘要样式。 是大部分感觉阿斯蒂芬报告爸爸 FVG
\end{abstract}
\textbf{关键词：}关键词一；关键词二；关键词三

\section*{Abstract}
Fill in the English abstract here. This paragraph maps to the English abstract style from schemdsalkfjisdnffima.
...
\subsection{研究背景}
这里填写二级标题下的正文内容。 你的说法那是的不能付款就

\begin{figure}[htbp]
\centering
\fbox{\rule{0pt}{2in}\rule{0.8\linewidth}{0pt}}
\caption{图1-1 示例图你的说法耐克森 DNF题}
\end{figure}
